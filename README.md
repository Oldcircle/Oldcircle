...
- [moeru-ai/airi](https://github.com/moeru-ai/airi/pull/1333) — Fix Telegram bot velin rendering, action loop, and LLM compatibility
- [Antigravity-Manager](https://github.com/lbjlaq/Antigravity-Manager/pull/2286) — Dynamic pro model fallback with account-aware remapping

## Tech Stack

`TypeScript` `React` `Python` `Rust` `AI / LLM` `Node.js`
